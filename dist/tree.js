...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["Tree"] = factory();
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function collapseFromLeaf(tree, leafNode) {
          try {
            ...
            if (!nodeLiElement.classList.contains("treejs-node__close"))
              nodeLiElement
                .getElementsByClassName("treejs-switcher")[0]
                .click();
          } catch (error) {
            return;
          }
        ...
        function expandFromRoot(tree, root) {
          ...
          if (root.hasOwnProperty("children")) {
            ...
            try {
              for (
                var _iterator = root.children[Symbol.iterator](), _step;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function _default(_options) {
          ...
          var postData = Object.entries(options.data)
